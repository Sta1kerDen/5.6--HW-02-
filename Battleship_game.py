...
class FieldOutException(FieldException):
    def __str__(self):
        return "Капитан, вы пытаетесь выстрелить за доску!"

class FieldUsedException(FieldException):
    def __str__(self):
        return "Капитан, вы уже стреляли в эту клетку"
...
class User(Player):
    def ask(self):
        while True:
            ...
            if len(cords) != 2:
                print(" Капитан, введите 2 координаты! ")
                continue
            
            x, y = cords
            
            if not(x.isdigit()) or not(y.isdigit()):
                print(" Капптан, необходимо вводить только числа! ")
                continue
    ...
    def loop(self):
        ...
        while True:
            ...
            if self.ai.board.count == 7:
                print("-"*20)
                print("Капитан выиграл!")
                break
            
            if self.us.board.count == 7:
                print("-"*20)
                print("О нет! Противник одержал победу!")
                break
            num += 1
